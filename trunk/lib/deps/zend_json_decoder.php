...
class Zend_Json_Decoder
{
     ...
     * {@link Zend_Json_Decoder::TYPE_ARRAY} and {@link Zend_Json_Decoder::TYPE_OBJECT} for
     * valid values
     * @return void
     */
    protected function __construct($source, $decodeType)
    {
        ...
        if (!in_array($decodeType, array(Zend_Json_Decoder::TYPE_ARRAY, Zend_Json_Decoder::TYPE_OBJECT)))
        {
            $decodeType = Zend_Json_Decoder::TYPE_ARRAY;
        }
     ...
     * return a StdClass object instead, pass {@link Zend_Json_Decoder::TYPE_OBJECT} to
     ...
     * either or {@link Zend_Json_Decoder::TYPE_ARRAY} or
     * {@link Zend_Json_Decoder::TYPE_OBJECT}; defaults to TYPE_ARRAY
     * @return mixed
     * @throws Exception
     */
    public static function decode($source = null, $objectDecodeType = Zend_Json_Decoder::TYPE_ARRAY)
    {
        if (null === $source) {
    ...
    protected function _decodeObject()
    {
        ...
        switch ($this->_decodeType) {
            case Zend_Json_Decoder::TYPE_OBJECT:
                ...
                break;
            case Zend_Json_Decoder::TYPE_ARRAY:
            default:
                $result = $members;
                break;
        }
                    ...
                    if ($chr == '\\') {
                        ...
                        switch ($chr) {
                            ...
                            case '\'' :
                                ...
                                break;
                            default:
                                throw new Exception("Illegal escape sequence '" . $chr . "'");
                        }
                    } elseif($chr == '"') {
                        break;
                    } else {
